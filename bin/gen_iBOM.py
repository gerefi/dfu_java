...
#
# here we produde gerefi2-git-iBom using gerbers, placement and BOM files as input.
# gerefi2-git-iBom adds 3D view of the PCB into the original https://github.com/openscopeproject/InteractiveHtmlBom
#
